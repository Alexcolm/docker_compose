...
<html lang="en">
    <%@include  file="header.jsp" %>
        <div class="app-content">
          <!--begin::Container-->
          <div class="botones center" style="display: flex; justify-content: center; align-items: center; padding: 10px;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmarEliminarModalLabel">Confirmar EliminaciÃ³n</h5>
